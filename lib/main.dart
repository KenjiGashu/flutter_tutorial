...
class TutorialHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var _handleGoToLista = () {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => ListaDeLugares()),
      );
    };
...
class ListaDeLugares extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
      ...
      body: GridView.count(
        ...
        children: <Widget>[
          Lugar(
              ...
              description: "uma pequena descricao"),
        ],
      ),
    );
  }
...
class Butao extends StatelessWidget {
  Butao({this.onPressed});

  final VoidCallback onPressed;

  @override
  Widget build(BuildContext context) {
    return RaisedButton(onPressed: onPressed, child: Text("Pesto?"));
  }
}

class Pestao extends StatelessWidget {
  Pestao({this.pesto});
